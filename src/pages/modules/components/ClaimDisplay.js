...
export const ClaimItem = ({ label, value }) => {
  const el = useMemo(() => {
  ...
  return (
    <Stack alignItems="center" direction="row" height={24} justifyContent="space-between" paddingX={3}>
...
function ClaimDisplay({ contents }) {
  return (
    <Stack spacing={1}>
