                ...
                <Grid item xs={6} sx={{}}>
                    <Box sx={{width: '60%', display: 'flex', flexDirection: 'column', pl: 4, mt: '20%'}}>
                        ...
                        <Box sx={{mt: 2, bgcolor: 'whitesmoke', width: '100%', borderRadius: 1}}>
                            <TextField fullWidth multiline rows={10} onChange={handleInput} value={description} id="description" />
                        </Box>
                        <Box sx={{mt: 0, width: '100%', display: 'flex', justifyContent: 'flex-end'}}>
                            <Typography variant='body1' sx={{color: 'whitesmoke'}}>
                                {5000 - description.length} characters left
                            </Typography>
                        </Box>
                    </Box>
                </Grid>
